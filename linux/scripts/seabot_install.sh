sudo apt install -y gpsd gpsd-clients gpsd-dbg ntp ntp-doc ntpstat socat nmap zsh git ssh cron cronutils screen i2c-tools htop pps-tools libgps-dev minicom
